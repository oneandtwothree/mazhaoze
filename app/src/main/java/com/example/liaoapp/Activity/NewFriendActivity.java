    ...
    private void initView() {
        ...
        mNewFriendAdapter = new CommonAdapter<>(mList, new CommonAdapter.OnBindDataListener<NewFriend>() {
            ...
            public void onBindViewHolder(final NewFriend model, final CommonViewHolder viewHolder, int type, final int position) {
                ...
                //根据Id查询用户信息
                BmobManager.getInstance().queryidFriend(model.getId(), new FindListener<IMUser>() {
                    @Override
                    public void done(List<IMUser> list, BmobException e) {
                        ...
                        if (e == null) {
                            ...
                            viewHolder.setImgurl(NewFriendActivity.this, R.id.iv_photo,
                                    imUser.getPhoto());
                            viewHolder.setImgsex(R.id.iv_sex, imUser.isSex() ?
